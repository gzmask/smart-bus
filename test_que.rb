...
b3.path_locations.each {|location| print "[" + location.latitude.to_s + "," + location.longitude.to_s + "]"}
puts ""
b4.path_locations.each {|location| print "[" + location.latitude.to_s + "," + location.longitude.to_s + "]"}
puts ""
b5.path_locations.each {|location| print "[" + location.latitude.to_s + "," + location.longitude.to_s + "]"}
puts ""
b6.path_locations.each {|location| print "[" + location.latitude.to_s + "," + location.longitude.to_s + "]"}
puts ""
#==========================================================
